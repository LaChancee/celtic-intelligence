...
const Footer = () => {
    return (
                ...
                <div className="md:px-12 lg:px-28">
                    <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
                        <div className={"flex place-content-center  gap-2"}>
                            ...
                            <h1 className="text-xl self-center font-bold text-primary">  Celtics-intelligence</h1>
                        </div>
                        <ul
                            role="list"
        ...
        >Copyright © Celtic Intelligence <span id="year"></span> | All right reserved</span>
                        </div>
                    </div>
                </div>
            </footer>
