...
const Article = ({ article }: { article : Article }) => {
    ...
    const publishedAt = (router.query.publishedAt as string[]) || []
                    ...
                    <div className="lg:col-span-2">
                        <div className="py-8 lg:pr-4 lg:pr-8">
                            <div className="space-y-5 lg:space-y-8">
                                ...
                                <h2 className="text-3xl font-bold lg:text-4xl lg:text-5xl dark:text-white">{title}</h2>
                                <div className="flex items-center gap-x-5">
                                    ...
                                    <p className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">{formatDate(publishedAt.toString())}</p>
                                </div>
